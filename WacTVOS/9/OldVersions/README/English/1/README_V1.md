...
WacTVOS 9 is an open source recreation of Apple's tvOS 9. It is part of the WacOS operating system project. 

| [**Predecessor:** (`wOS 8/WacTVOS_8`)](https://github.com/seanpm2001/WacTVOS_8) [`(Local`)](/) | [**Successor:** (`WacTVOS 10`)](https://github.com/seanpm2001/WacTVOS_10) [`(Local)`](/WacTVOS/10/) |
|---|---|
...
The previous system (WacTVOS 8) is not considered "pure" while at the same time, it is. It is a problem I am still trying to work out. The "pure" version would be a wOS variant (8) that has WacTVOS functionality, while at the same time, it is being merged here.

WacOS Pure is a standards set that ensures that WacOS matches the Apple equivalent without malicious methods.

The current version (WacTVOS 9) is currently in Pure mode.
...
**File version:** `1 (2022, Monday, June 20th at 9:10 pm PST)`
...
<details><summary><p lang="en"><b>Version 1 (2022, Monday, June 20th at 9:10 pm PST)</b></p></summary>
