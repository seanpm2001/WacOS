...
param2_callName:(param2_type)param2_varName;
  @WacOS_X_10_1_ObjectiveC classname : superclassname {
    // Output:
    // Project language file 3
    // For: WacOS/APIs
    // About:
    // I chose Objective-C as the first project language file for this project (WacOS X 10.1) as Objective-C is a core language for Apple API sets, and I need support for it. It may be possible to use this language at the system level for this project alongside C and x86 Assembly. It is getting its own project language file, starting here.
    NSLog(@"Project language file 3");
    NSLog(@"For: WacOS X 10.1");
    NSLog(@"About:");
    NSLog(@"I chose Objective-C as the first project language file for this project (WacOS X 10.1) as Objective-C is a core language for Apple API sets, and I need support for it. It may be possible to use this language at the system level for this project alongside C and x86 Assembly. It is getting its own project language file, starting here.");
    break;
}
@end
/* File info
* File version: 1 (2022, Wednesday, June 1st at 2:23 pm PST)
