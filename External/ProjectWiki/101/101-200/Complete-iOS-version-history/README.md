...
Supported on the iPod Touch (2nd generation) starting with iPhone OS 2.1.1.
...
**Written on:** `2021 Tuesday September 28th at 4:46 pm`

**Last revised on:** `2021 Tuesday September 28th at 4:46 pm`

**File format** `Markdown document (*.md *.mkd *.markdown)`

**Line count (including blank lines and compiler line):** `9,988`

**Article version:** `1 (2021 Tuesday September 28th at 4:46 pm)`

**Majority language:** `English (US) / Markdown`

**Minority languages:** `English (US) / Markdown`

**Current revision:** `1 (2021, Tuesday, September 28th at 3:46 pm)`

**All times are UTC-7 (PDT/Pacific Time)**

**You may need special rendering support for the `<dropdown>` HTML tag being used in this document**

**Page derived from:** `iOS version history (V1)`

**Developer notes:** `This took forever to write, and it can't be previewed in the Wiki yet, as it is too long. This document is over 9900 lines long, and is over 330 kilobytes in size, minus the images`

**Derivitive revision date:** `1 (2021, Tuesday, September 28th at 3:34 pm)`
