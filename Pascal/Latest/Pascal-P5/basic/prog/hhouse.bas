...
65 CLEAR
70 V=25:W=36:G=18
80 GOSUB 1600:REM INITIALISE
90 PRINT CHR$(26):PRINT "HAUNTED HOUSE"
100 PRINT "-------------"
...
410 IF VB<V AND OB>0 AND C(OB)=0 THEN M$="YOU DON'T HAVE THE '"+W$+"'"
...
970 RETURN
980 IF OB>G THEN M$="I CAN'T CARRY THE "+W$:RETURN
985 IF L(OB)<>RM THEN M$="IT ISN'T HERE"
990 IF F(OB)<>0 THEN M$="WHAT "+W$+"?"
1000 IF C(OB)=1 THEN M$="YOU ALREADY HAVE IT"
1010 IF OB>0 AND L(OB)=RM AND F(OB)=0 THEN C(OB)=1:L(OB)=65:M$=H$(4)+W$
1020 RETURN
...
1150 IF (OB=3 OR OB=36) AND C(3)=1 AND F(34)=0 THEN M$=H$(5)
1160 IF C(5)=1 AND OB=5 THEN M$="THE SCRIPT IS IN AN ALIEN TONGUE"
1170 RETURN
1180 M$="OK "+W$
1190 IF C(3)=1 AND OB=34 THEN M$=H$(6):IF RM<>45 THEN RM=INT(RND*63)
...
1270 IF OB=13 AND C(13)=1 THEN M$="WOOSH!"
...
1410 IF OB=26 AND C(16)=1 AND F(26)=1 THEN F(26)=0:M$="PFFFT! GOT THEM"
1420 RETURN
...
1570 PRINT "YOUR SCORE IS ";S:IF S>18 THEN PRINT H$(14):STOP
...
1665 DATA "DIG","SWING","CLIMB","LIGHT","EXTINGUISH","SPRAY","USE","UNLOCK","DROP","SCORE"
1680 FOR I=1 TO V
1690 READ V$(I)
1700 NEXT I
...
1860 DATA "CLEARING BY HOUSE","PATH","SIDE OF HOUSE","BACK OF HALL","DARK ALCOVE"
1865 DATA "SMALL DARK ROOM","BOTTOM OF STAIRCASE","WIDE PASSAGE"
1880 DATA "SLIPPERY STEPS","CLIFFTOP","NEAR CRUMBLING WALL","GLOOMY PASSAGE"
1885 DATA "POOL OF LIGHT","IMPRESSIVE VAULTED HALL","HALL BY THICK DOOR"
...
2140 H$(14)="WELL DONE - YOU FINISHED 'HAUNTED HOUSE'":RETURN
