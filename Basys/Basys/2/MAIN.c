...
#include <string.h>
// Start of script
// BaSYSTEM 2 - A compatibility layer for Apple System 2
...
int programs() {
	...
	int controlPanel() {
		...
		int sysInfo() {
			...
			int aboutBASYSOne() {
				printf("About BaSYS/2");
				printf("WacOS operating system/BASYS/2");
...
/* File info
* File version: 1 (2021, Wednesday, December 22nd at 3:55 pm)
