...
#include <string.h>
// Start of script
// BaSYSTEM 4 - A compatibility layer for Apple System 4
...
int programs() {
	...
	int controlPanel() {
		...
		int sysInfo() {
			...
			int aboutBASYSFour() {
				printf("About BaSYS/4");
				printf("WacOS operating system/BASYS/4");
				printf("Version 0.01 Alpha");
				printf("2021-2021");
				return credits();
				break;
			}
			return aboutBASYSFour();
			break;
		}
		return startCPanel();
		break;
...
/* File info
* File version: 1 (2021, Wednesday, December 22nd at 4:01 pm)
