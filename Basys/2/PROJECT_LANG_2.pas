...
begin
    Write('I have decided to have the second project language file for this project (WacOS/BaSYS 2) to be Pascal, as Pascal is one of the languages the system this project is based on is written in. It comes second, after C, as it is an application level, and not a system level language. Assembly will come 3rd, as it is not used as often as the other 2.')
...
// File version: 1 (2022, Sunday, May 8th at 6:30 pm PST)
