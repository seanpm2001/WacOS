...
#include <string.h>
// Start of script
// BaSYSTEM 5 - A compatibility layer for Apple System 5
...
int programs() {
	...
	int controlPanel() {
		...
		int sysInfo() {
			...
			int aboutBASYSFive() {
				printf("About BaSYS/5");
				printf("WacOS operating system/BASYS/5");
				printf("Version 0.01 Alpha");
				printf("2021-2021");
				return credits();
				break;
			}
			return aboutBASYSFive();
			break;
		}
		return startCPanel();
		break;
...
/* File info
* File version: 1 (2021, Wednesday, December 22nd at 4:05 pm)
